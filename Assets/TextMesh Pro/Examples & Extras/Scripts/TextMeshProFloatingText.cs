    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Start()
        {
            if (SpawnType == 0)
            {
                ...
                m_textMeshPro.color = new Color32(
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                m_floatingText_Transform.position += new Vector3(
                    0,
                    starting_Count * Time.deltaTime,
                    0
                );

                // Align floating text perpendicular to Camera.
                if (
                    !lastPOS.Compare(m_cameraTransform.position, 1000)
