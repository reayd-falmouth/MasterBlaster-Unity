    ...
    public class ArenaShrinker : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (!indestructiblePrefab)
                Debug.LogWarning("[ArenaShrinker] Indestructible prefab not assigned.");
            if (!indestructiblesTilemap)
                Debug.LogError("[ArenaShrinker] Indestructibles Tilemap not found/assigned.");
        ...
        private void ComputeInsideBounds()
        {
            if (!indestructiblesTilemap)
            {
                Debug.LogError("[ArenaShrinker] No Indestructibles Tilemap assigned.");
                return;
            }
