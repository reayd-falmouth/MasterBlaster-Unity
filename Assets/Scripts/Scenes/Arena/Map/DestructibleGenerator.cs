...
namespace Scenes.Arena.Map
{
    ...
    public class DestructibleGenerator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (!destructiblesTilemap)
            {
                Debug.LogWarning("[DestructibleGenerator] Destructibles tilemap not found — skipping generation.");
                return;
            }
        ...
        private void Generate()
        {
            ...
            if (tile == null)
            {
                Debug.LogWarning("[DestructibleGenerator] No destructible tile found. " +
            ...
            {
                Debug.LogWarning("[DestructibleGenerator] Computed bounds are degenerate — nothing to generate.");
                return;
            }
            ...
            Debug.Log($"[DestructibleGenerator] Generated destructibles in bounds " +
